    ...
    R: RangeBounds<Q>,
{
    match (range.start_bound(), range.end_bound()) {
        ...
        (Included(s), Included(e)) if s > e => panic!("range start is greater than range end in BTreeMap"),
        (Included(s), Excluded(e)) if s > e => panic!("range start is greater than range end in BTreeMap"),
        (Excluded(s), Included(e)) if s > e => panic!("range start is greater than range end in BTreeMap"),
        (Excluded(s), Excluded(e)) if s > e => panic!("range start is greater than range end in BTreeMap"),
        _ => {}
    };
